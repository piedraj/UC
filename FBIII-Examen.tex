...
{\normalsize \rm Examen parcial del Bloque IV}\\
%{\normalsize \rm 22 de mayo de 2023}\\
%{\normalsize \rm 21 de mayo de 2024}\\
{\normalsize \rm 22 de mayo de 2025}\\
\end{verse} 
...
\item[] {\bf La extensi\'on m\'axima es de dos caras.}
\end{enumerate}
\hrule
...
\item Calcular la energ\'ia (en MeV) que debe tener una part\'icula alfa para alcanzar la superficie de un n\'ucleo de oro (${\rm _{~79}^{197}Au}$) suponiendo que el n\'ucleo de oro permanece inm\'ovil. (${\rm r_0 = 1,2 \times 10^{-15}~m = 1,2~fm}$)
